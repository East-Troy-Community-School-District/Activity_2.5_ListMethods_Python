...
modify this program by having it remove the
first occurance of the number 3.9 (don't just
remove it in the brackets [], use the remove()
method). Check your work by having it print
the list the console.
'''
